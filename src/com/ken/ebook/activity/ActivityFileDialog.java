...
public class ActivityFileDialog extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		RelativeLayout layout = (RelativeLayout) getLayoutInflater().inflate(
				R.layout.file_dialog_main, null);
				...
				.setNegativeButton(android.R.string.cancel,
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
									int which) {
							sendToMain(FragmentBooks.RESULT_CODE_CANCEL, "");
							}
						}).create();
		...
		// ViewGroup.MarginLayoutParams mlop = new
	...
	private void returnFilename(String filepath) {
		...
		sendToMain(FragmentBooks.RESULT_CODE_OK,filepath);
		
	}
	public void sendToMain(int resultcode, String value)
	 {
